...
<div class="position-fixed bg-white fixed-top">
          ...
          <div class="collapse item navbar-collapse" id="navbarNav">
            <ul class="navbar-nav  align-items-baseline">
              ...
              <li class="nav-item" id='english'>
                <a class="nav-link"  href="About.php?lg=franch">
              ...
              <li class="nav-item " id='franch'>
                <a class="nav-link"  href="About.php?lg=anglish"><img style='width:30px;' src="src/img/united-states.svg" alt=""></a>
              </li>
      ...
      <section class='m-top'>
          ...
          <div class="d-flex justify-content-around flex-column-reverse align-items-center flex-lg-row m-5">
            <div class="w-100 w-lg-100 About_pic">
